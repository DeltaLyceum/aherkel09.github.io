...
<h2>Step 1: Assembly</h2>

Begin by placing the Breadboard Ultrasonic Sensor on the Breadboard. Note that the sensor has four pins: a trig pin, an echo pin, a --pin and a GND pin.
