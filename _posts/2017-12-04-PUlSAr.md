...
<ul>
<li>Access to the [Arduino Web Editor]("https://create.arduino.cc/projecthub/Arduino_Genuino/getting-started-with-the-arduino-web-editor-4b3e4a") or [Arduino IDE]({{post.ide_url}})</li>
